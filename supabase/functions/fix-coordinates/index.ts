...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    console.log(`User ${userId} attempting to fix coordinates`);
    ...
    if (!rateLimitResult.allowed) {
      console.warn(`Admin ${userId} rate limited for fix-coordinates`);
      return new Response(
        JSON.stringify({ 
          success: false, 
    ...
    console.log(`Admin user ${userId} authorized for fix-coordinates operation`);
